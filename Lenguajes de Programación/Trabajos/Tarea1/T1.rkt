...
(define (mysterious-list n)
  (if (zero? n)
      '()
      (map fl (map eval (map mysterious-cf (from-to 0 (- n 1)))))))


;; A que numero tiende (mysterious-cf k) cuando k tiende a infinito?
;; Respuesta: Tiende a pi, lo que es 3.14159...
